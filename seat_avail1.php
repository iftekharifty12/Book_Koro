...
<?php
    ...
    <div class="jumbotron container">
        <form method="post">
            ...
            <input type="number" name="total_seat" class="form-control" placeholder="total number of seat">
    ...
    if(isset($_POST['proceed_to_book_seat']))
    {
        ...
        <div class="container booking-selection">
            ...
            <p>FIRST PAY THEN CONTINUE TO BOOK YOUR SEATS     <a href="payment2.php">Pay</a> </p><br>
                ...
                <button name="book_seat">book seat</button><br><br>
